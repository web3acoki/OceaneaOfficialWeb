  ...
  return <>
    <DebugBg className={isMobileMode
      ...
      <p className={isMobileMode
        ...
        : "fmt-[18/1320] ft-[28/1320] fmx-[300/1320] aspect-1320/119 fls-[-0.96/1320] text-[#7D7D7D] text-center"}>{subtitleText}</p>
      <div className={isMobileMode
          ...
          <div key={card.title} className={isMobileMode
            ...
            <div className={isMobileMode
              ...
              <p className={isMobileMode
                ...
                : "fmt-[140/300] ft-[32/1320] font-medium text-center text-white"}>{card.title}</p>
              <p className={isMobileMode
                ? "fmt-[10/165] fmx-[8/165] ft-[9/340] fls-[-0.42/340] flh-[10/340] text-center text-white"
                : "fmt-[10/300] fmx-[35/300] ft-[24/1320] fls-[-0.72/1320] flh-[25/1320] text-center text-white"}>{card.desc}</p>
            </div>
          </div>
        ))}
      </div>
