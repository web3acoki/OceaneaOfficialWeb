...
export default function Welcome() {
  ...
  return (
    <DebugBg className={isMobileMode
          ...
          : "relative fmt-[125/1320] w-full aspect-1320/843 overflow-hidden fr-[50/1320] @container-[size]"
      }>
      <img
        ...
        className={isMobileMode
          ...
          : "absolute max-w-none object-cover w-1538/1320 h-1025/843 fml-[-216/1320] fmt-[-16/1320]"
        }
      />
      <p className={isMobileMode
        ...
        : "absolute fmt-[173/1320] fml-[600/1320] w-570/1320 text-right ft-[60/1320] font-medium flh-[65/1320] fls-[-1.8/1320] text-[#F5FDFF] whitespace-pre-line"
