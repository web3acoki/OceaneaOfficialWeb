export default function Frotier() {
  const mainTitleClassName =
    "relative text-center font-medium leading-[0.99] ft-[96/1320] tracking-[-0.03em]";
...
possibilities for exploration, innovation, and discovery.`;
  ...
  return <>
    <section className="fmx-[300/1920] fmt-[388/1920] aspect-square flex flex-col @container-[size]">
      <div className="relative">
        <div className="absolute inset-0 flex items-center justify-center fg-[40/1920]">
          <img src="/frontier-left.svg" alt="" className="w-126/1320" />
          <img src="/frontier-right.svg" alt="" className="w-126/1320" />
        </div>
      ...
      <div className="fmt-[60/1920] aspect-1320/648 overflow-hidden fr-[50/1920] relative">
        <img src="/frontier-overlay.jpg" alt="" className="w-full h-full object-cover"/>
      </div>
