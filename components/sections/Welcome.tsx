...
export default function Welcome() {
   ...
   */
  const divers = [
    {src: "/welcome-diver-1.png",imgClass:"absolute w-169/1320 fmt-[434/1320] fml-[62/1320]"},
    {src: "/welcome-diver-2.png",imgClass:"absolute w-125/1320 fmt-[78/1320] fml-[554/1320]"},
    {src: "/welcome-diver-5.png",imgClass:"absolute w-196/1320 fmt-[183/1320] fml-[829/1320]"},
    {src: "/welcome-diver-4.png",imgClass:"absolute w-196/1320 fmt-[500/1320] fml-[969/1320]"},
    {src: "/welcome-diver-3.png",imgClass:"absolute w-230/1320 fmt-[762/1320] fml-[1026/1320]"},
  ] as const;
...
and empowering everyone to cocreate and share in the ocean together.`;
  ...
  return <>
    <div className="relative -translate-x-1/2 left-1/2 fmt-[147/1320] w-[min(calc(100vw-80px),1320px)] aspect-1320/978 overflow-hidden fr-[64/1320] @container-[size]">
      ...
      <div className="relative flex flex-col items-center text-center text-white">
        <p className={"fmt-[356/1320] fmx-[73/1320] ft-[82/1320] font-medium flh-[85/1320] tracking-[-0.03em]"}>{titleText}</p>
